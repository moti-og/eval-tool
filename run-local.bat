...
set MONGODB_URI=mongodb+srv://eval-tool:1p5IHg92yfd9QgMp@cluster0.rolg174.mongodb.net/llm_reviews?retryWrites=true^&w=majority^&appName=Cluster0^&maxPoolSize=1^&serverSelectionTimeoutMS=5000^&connectTimeoutMS=10000
